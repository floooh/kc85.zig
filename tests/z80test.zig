...
fn tick(num_ticks: usize, pins_in: u64, userdata: usize) u64 {
    ...
    if ((pins & MREQ) != 0) {
        ...
        if ((pins & RD) != 0) {
            ...
            pins = CPU.setData(pins, @as(u8, @truncate(CPU.getAddr(pins))) *% 2);
        } else if ((pins & WR) != 0) {
            // an IO output access
...
fn LD_inni_HLddIXIY() void {
    ...
    T(0x0201 == cpu.r16(HL));
    T(16 == step(&cpu));
    T(0x0201 == mem16(0x1000));
    T(0x1001 == cpu.WZ);
    T(10 == step(&cpu));
    T(0x1234 == cpu.r16(BC));
    T(20 == step(&cpu));
    T(0x1234 == mem16(0x1002));
    T(0x1003 == cpu.WZ);
    T(10 == step(&cpu));
    T(0x5678 == cpu.r16(DE));
    T(20 == step(&cpu));
    T(0x5678 == mem16(0x1004));
    T(0x1005 == cpu.WZ);
    T(10 == step(&cpu));
    T(0x9ABC == cpu.r16(HL));
    T(20 == step(&cpu));
    T(0x9ABC == mem16(0x1006));
    T(0x1007 == cpu.WZ);
    T(10 == step(&cpu));
    T(0x1368 == cpu.SP);
    T(20 == step(&cpu));
    T(0x1368 == mem16(0x1008));
    T(0x1009 == cpu.WZ);
    T(14 == step(&cpu));
    T(0x4321 == cpu.IX);
    T(20 == step(&cpu));
    T(0x4321 == mem16(0x100A));
    T(0x100B == cpu.WZ);
    T(14 == step(&cpu));
    T(0x8765 == cpu.IY);
    T(20 == step(&cpu));
    T(0x8765 == mem16(0x100C));
    T(0x100D == cpu.WZ);
    ok();
}
...
fn PUSH_POP_qqIXIY() void {
    ...
    T(0x0100 == cpu.SP);
    T(11 == step(&cpu));
    T(0xEF00 == mem16(0x00FE));
    T(0x00FE == cpu.SP);
    T(11 == step(&cpu));
    T(0x1234 == mem16(0x00FC));
    T(0x00FC == cpu.SP);
    T(11 == step(&cpu));
    T(0x5678 == mem16(0x00FA));
    T(0x00FA == cpu.SP);
    T(11 == step(&cpu));
    T(0x9ABC == mem16(0x00F8));
    T(0x00F8 == cpu.SP);
    T(15 == step(&cpu));
    T(0x2345 == mem16(0x00F6));
    T(0x00F6 == cpu.SP);
    T(15 == step(&cpu));
    T(0x6789 == mem16(0x00F4));
    T(0x00F4 == cpu.SP);
    T(10 == step(&cpu));
    T(0x8967 == cpu.r16(FA));
    T(0x00F6 == cpu.SP);
...
fn EX() void {
    ...
    T(0x0100 == cpu.SP);
    T(11 == step(&cpu));
    T(0x1234 == mem16(0x00FE));
    T(19 == step(&cpu));
    T(0x1234 == cpu.r16(HL));
    T(cpu.WZ == cpu.r16(HL));
    T(0x5678 == mem16(0x00FE));
    T(14 == step(&cpu));
    T(0x8899 == cpu.IX);
    T(23 == step(&cpu));
    T(0x5678 == cpu.IX);
    T(cpu.WZ == cpu.IX);
    T(0x8899 == mem16(0x00FE));
    T(14 == step(&cpu));
    T(0x6677 == cpu.IY);
    T(23 == step(&cpu));
    T(0x8899 == cpu.IY);
    T(cpu.WZ == cpu.IY);
    T(0x6677 == mem16(0x00FE));
    ok();
}
...
fn SUB_rn() void {
    ...
    T(4 == step(&cpu));
    T(0x7F == cpu.regs[A]);
    T(flags(&cpu, HF | VF | NF));
    T(4 == step(&cpu));
    T(0xBF == cpu.regs[A]);
    T(flags(&cpu, SF | VF | NF | CF));
    T(4 == step(&cpu));
    T(0x00 == cpu.regs[A]);
    T(flags(&cpu, ZF | NF));
    T(7 == step(&cpu));
...
fn INC_DEC_r() void {
    ...
    T(4 == step(&cpu));
    T(0x80 == cpu.regs[E]);
    T(flags(&cpu, SF | HF | VF | CF));
    T(4 == step(&cpu));
    T(0x7F == cpu.regs[E]);
    T(flags(&cpu, HF | VF | NF | CF));
    T(4 == step(&cpu));
    T(0x3F == cpu.regs[H]);
    T(flags(&cpu, CF));
    T(4 == step(&cpu));
...
fn INC_DEC_iHLIXIYi() void {
    ...
    T(23 == step(&cpu));
    T(0x80 == mem[0x1002]);
    T(flags(&cpu, SF | HF | VF));
    T(23 == step(&cpu));
    T(0x7F == mem[0x1002]);
    T(flags(&cpu, HF | PF | NF));
    ok();
}
...
fn RLCA_RLA_RRCA_RRA() void {
    ...
    T(4 == step(&cpu));
    T(0x41 == cpu.regs[A]);
    T(flags(&cpu, SF | ZF | VF | CF));
    T(4 == step(&cpu));
    T(0x82 == cpu.regs[A]);
    T(flags(&cpu, SF | ZF | VF));
    T(4 == step(&cpu));
    T(0x41 == cpu.regs[A]);
    T(flags(&cpu, SF | ZF | VF));
    T(4 == step(&cpu));
...
fn IRQ() void {
    ...
    T(cpu.IM == 2); // IM 2
    T(4 == inner.step(&cpu));
    T(cpu.regs[A] == 0); // XOR A
    T(9 == inner.step(&cpu));
    T(cpu.I == 0); // LD I,A
    T(29 == inner.step(&cpu));
    T(cpu.PC == 0x0200);
    T(cpu.iff2 == false);
    T(cpu.SP == 0x02FE); // OUT (0x01),A
    T(4 == inner.step(&cpu));
    T(cpu.iff2); // EI
    T(10 == inner.step(&cpu));
    T(cpu.r16(HL) == 0x1111);
    T(cpu.iff2 == true); // LD HL,0x1111
    T(14 == inner.step(&cpu));
    T(cpu.PC == 0x010B);
    T(inner.reti_executed); // RETI
    _ = inner.step(&cpu);
    T(cpu.r16(HL) == 0x3333); // LD HL,0x3333
    ok();
}
