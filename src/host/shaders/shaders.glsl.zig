...
//
//    Cmdline:
//        sokol-shdc -i shaders.glsl -o shaders.glsl.zig -l glsl410:metal_macos:hlsl4:glsl300es -f sokol_zig
//
//    Overview:
//    =========
...
//
//
const upscale_vs_source_glsl410 = [183]u8 {
    ...
    0x3b,0x0a,0x20,0x20,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x69,0x6e,0x5f,0x70,0x6f,
...
//
//
const upscale_fs_source_glsl410 = [175]u8 {
...
//
//
const display_vs_source_glsl410 = [219]u8 {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x34,0x31,0x30,0x0a,0x0a,0x6c,0x61,
    0x79,0x6f,0x75,0x74,0x28,0x6c,0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,
    0x30,0x29,0x20,0x69,0x6e,0x20,0x76,0x65,0x63,0x32,0x20,0x69,0x6e,0x5f,0x70,0x6f,
    0x73,0x3b,0x0a,0x6c,0x61,0x79,0x6f,0x75,0x74,0x28,0x6c,0x6f,0x63,0x61,0x74,0x69,
...
pub fn upscaleShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        .GLCORE => {
            desc.attrs[0].name = "in_pos";
            desc.vs.source = &upscale_vs_source_glsl410;
            desc.vs.entry = "main";
            desc.fs.source = &upscale_fs_source_glsl410;
            desc.fs.entry = "main";
            desc.fs.images[0].used = true;
            desc.fs.images[0].multisampled = false;
            desc.fs.images[0].image_type = ._2D;
